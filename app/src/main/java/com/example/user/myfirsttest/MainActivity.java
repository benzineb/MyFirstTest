        ...
        ((Button) findViewById(R.id.button)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (((nom.getText().toString().matches(""))) || (prenom.getText().toString().matches(""))) {
                    Toast.makeText(MainActivity.this, "verifier les zones de saisie", Toast.LENGTH_SHORT).show();
                } else {
                    Intent i = new Intent(MainActivity.this, Bonjour.class);
                    String strName = null;
                    i.putExtra("fullname",nom.getText()+" "+prenom.getText());
                    startActivity(i);
                }
            }
        });
